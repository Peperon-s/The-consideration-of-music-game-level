...
def video_to_photo(video_path_list,encode_path):
    import numpy as np
    import cv2
    import os
...
a = video_path("J:/musicgame/predict_video")
print(a)
try:
    os.mkdir("j:/musicgame/predict_photo/")
except FileExistsError:
    pass

video_to_photo(a,'j:/musicgame/predict_photo/')
